// To parse this data:
//
//   import { Convert, SearchGifsRespo } from "./file";
//
//   const searchGifsRespo = Convert.toSearchGifsRespo(json);
//
// These functions will throw an error if the JSON doesn't
// match the expected interface, even if the JSON is valid.

export interface SearchGifsRespo {
    data:       Gif[];
...
export class Convert {
    public static toSearchGifsRespo(json: string): SearchGifsRespo {
        return cast(JSON.parse(json), r("SearchGifsRespo"));
    }

    public static searchGifsRespoToJson(value: SearchGifsRespo): string {
        return JSON.stringify(uncast(value, r("SearchGifsRespo")), null, 2);
    }
}
